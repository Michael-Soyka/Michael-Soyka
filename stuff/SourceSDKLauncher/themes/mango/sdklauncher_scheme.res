...
Scheme
{
	...
	Colors
	{
		...
		// base colors
		"BaseText"			"0 0 0 255"	// used in text windows, lists
		"BrightBaseText"	"255 255 255 255"	// brightest text
		"SelectedText"		"20 20 20 255"	// selected text
		...
		"BrightControlText"	"164 126 64 255"	// use for selected controls
		"DisabledText1"		"25 25 25 255"	// disabled text
		"DisabledText2"		"45 45 45 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"117 134 102 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"212 204 195 255"		// background color of controls
		"ControlDarkBG"		"90 106 80 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"2 62 138 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"177 177 165 255"	// background color of any selected text or menu item
		"SelectionBG2"		"162 162 150 255"		// selection background in window w/o focus
		"ListBG"			"247 237 226 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"0 0 0 255"
		"TitleDimText"		"20 20 20 255"
		"TitleBG"			"246 189 96 0"
		"TitleDimBG"		"246 189 96 0"
		...
		// border colors
		"BorderBright"		"93 130 169 255"	// the lit side of a control
		"BorderDark"		"40 56 125 255"		// the dark/unlit side of a control
