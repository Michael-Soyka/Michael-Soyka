...
Scheme
{
	...
	Colors
	{
		...
		// background colors
		"ControlBG"			"0 119 182 255"		// background color of controls
		"ControlDarkBG"		"90 106 80 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"2 62 138 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"3 4 94 255"	// background color of any selected text or menu item
		"SelectionBG2"		"3 4 94 255"		// selection background in window w/o focus
		"ListBG"			"2 62 138 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"255 255 255 255"
		"TitleDimText"		"136 145 128 255"
		"TitleBG"			"0 119 182 0"
		"TitleDimBG"		"0 119 182 0"
